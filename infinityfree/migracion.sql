-- ============================================================
-- MIGRACION a Generacion 2 (esquema nuevo)
-- Ejecutar UNA vez en phpMyAdmin (pestaña SQL), pegar todo y Continuar.
-- Borra las tablas viejas y crea las nuevas. NO tienes entrenos
-- registrados (registro_series estaba vacio), asi que no pierdes datos.
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;
DROP TABLE IF EXISTS registro_series;
DROP TABLE IF EXISTS registro_dias;
DROP TABLE IF EXISTS plan_rutina;
DROP TABLE IF EXISTS sincronizaciones_plan;
...
CREATE TABLE sincronizaciones_plan (
  id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  semana_inicio DATE NOT NULL,
...
-- Semana semilla (lunes 2026-06-22).
